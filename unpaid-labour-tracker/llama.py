...
def suggestion(input):
    ...
    """
    # Initialize conversation with a system message to define AI behavior
    messages = [{"role": "system", "content": "Suggest some common chores/mental labour related to the household described. For example, planning dinner, budgeting, appointments, children."}]
    print("Briefly describe your household.\n")
...
def suggestion_json(input):
    ...
    """
    # Initialize conversation with a system message to define AI behavior
    messages = [{"role": "system", "content": "List common chores/mental labour related to the household described. For example, planning dinner, budgeting, appointments, children. Summarise these categories of chores in list format. Your out"}]
    print("Briefly describe your household.\n")
